...
lv70 | lv80 | lv90
Ventus PEN 110 | Main Skill Lv. +3 | Splendid Vortex +3
Skill DMG 20% | Skill DMG 20% | Distant Prayer +3
ATK% 12% | ATK% 12% |
...
@pot(Gale Bastion) @pot(Wind Banish) @pot(Turbulent Flow, 6) @pot(Wind Erosion Havoc, 6) @pot(Forest Princess' Blessing, 6)
...
@pot(Flower Formation: Waves) @pot(Flower Formation: Turbulent) @pot(Flower Formation: Convergence, 6) @pot(Wind Demon Seed, 6) @pot(Flower Formation: Erosion, 6) @pot(Flower Formation: Blast, 1+) @pot(Almighty Leader, 1+)

### Optional

@pot(Self-Improvement, 1+)
